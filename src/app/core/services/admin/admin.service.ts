...
export class AdminService {
  ...
  getPatientById(patientId: string): Observable<any> {
    ...
    if (role === 'doctor' && userId) {
      ...
      // Fetch patient data using getUserDetails, as it returns the logged-in user's details
  ...
  updatePatientByDoctor(patientId: string, patientData: any): Observable<any> {
    return this.http
      .put<any>(
